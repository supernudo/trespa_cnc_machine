 ...
 *
 *	Based on revision: Id: commands_cs.c,v 1.4 2009/05/02 10:08:09 zer0 Exp
 * 
...
prog_char csb_axis_x_str[] = "axis_x";
struct csb_list csb_list[] = {
	{ .name = csb_axis_x_str, .csb = &maindspic.axis_x },
};
